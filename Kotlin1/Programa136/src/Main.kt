...
/*Definir un objeto nombrado:
            object Mayor {
con tres métodos llamados "maximo" con dos parámetros cada uno. Los métodos difieren en que uno recibe tipos de datos Int,
otro de tipos Float y finalmente el último recibe tipos de datos Double. Los tres métodos deben retornar el mayor de los
dos datos que reciben.*/
object Mayor {
